      ...
      <div>
        ...
        <ul className="teamRoster">
          {this.props.pokemon.map((pokemon, index) => {
            return (
              <MomentumSingle pokemon={pokemon} key={index} teamId={this.props.teamId} getRoster={this.props.getRoster} addToChosen={this.addToChosen} removeFromChosen={this.removeFromChosen} chosen={this.state.chosen} lockStatuses={this.props.lockStatuses}/>
            )
          })}
        </ul>
        <br></br>
